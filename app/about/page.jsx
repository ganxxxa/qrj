...
const Page = () => {
  ...
  return (
    <main
      className="flex sm:px-10 md:px-16 min-h-screen flex-col items-center justify-between py-24 overflow-x-hidden bg-white"
      ref={mainRef}
    >
      ...
      <div ref={textRef} className="relative w-screen h-[150vh]">
        <h1 className="absolute top-1/3 left-1/2 -translate-y-1/3 -translate-x-1/2 uppercase whitespace-nowrap text-[7vw] sm:text-5xl lg:text-6xl  2xl:text-[3.8vw] text-slate-100 font-bold ">
          About garage
        </h1>
      </div>
